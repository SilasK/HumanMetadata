...
class SRAUtils:
    ...
    def getSraUrlFromRunAccession(accesion):
        ...
        if not accesion.startswith("ERR") and not accesion.startswith("SRR") and not accesion.startswith("DRR"):
    ...
    def getInfoFromRunAcc(run):
        if not run.startswith("ERR") and not run.startswith("SRR") and not run.startswith("DRR"):
    ...
    def getInfoFromSubmissionAcc(submission):
        if not submission.startswith("ERA") and not submission.startswith("SRA") and not submission.startswith("DRA"):
    ...
    def getInfoFromSampleAcc(sample):
        if not sample.startswith("ERS") and not sample.startswith("SRS") and not sample.startswith("DRS"):
    ...
    def getInfoFromProjectAcc(project):
        if not project.startswith("ERP") and not project.startswith("SRP") and not project.startswith("DRP"):
    ...
    def getInfoFromExperimentAcc(experiment):
        if not experiment.startswith("ERX") and not experiment.startswith("SRX") and not experiment.startswith("DRX"):
    ...
    def getInfoFromSRAIdentifier(identifier):
        if identifier.startswith("ERX") or identifier.startswith("SRX") or identifier.startswith("DRX"):
            return SRAUtils.getInfoFromExperimentAcc(identifier)
        elif identifier.startswith("ERP") or identifier.startswith("SRP") or identifier.startswith("DRP"):
            return SRAUtils.getInfoFromProjectAcc(identifier)
        elif identifier.startswith("ERS") or identifier.startswith("SRS") or identifier.startswith("DRS"):
            return SRAUtils.getInfoFromSampleAcc(identifier)
        elif identifier.startswith("ERR") or identifier.startswith("SRR") or identifier.startswith("DRR"):
